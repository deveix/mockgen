...
export function Form() {
  ...
  const background = template.background as HangedUpTemplate["background"]

  return (
    <Card>
      <CardHeader>
        <CardTitle>Hanged Up Properties</CardTitle>
        <CardDescription>
          Customize your hanged up template properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>

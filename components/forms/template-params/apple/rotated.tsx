...
export function Form() {
  ...
  const params = template.params as RotatedTemplate["params"]
  const background = template.background as RotatedTemplate["background"]

  return (
    <Card>
      <CardHeader>
        <CardTitle>Rotated Properties</CardTitle>
        <CardDescription>
          Customize your rotated template properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>

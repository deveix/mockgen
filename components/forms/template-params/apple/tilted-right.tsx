...
export function Form() {
  ...
  const params = template.params as TiltedRightTemplate["params"]
  const background = template.background as TiltedRightTemplate["background"]

  return (
    <Card>
      <CardHeader>
        <CardTitle>Tilted Right Properties</CardTitle>
        <CardDescription>
          Customize your tilted right template properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>

...
export function Form() {
  ...
  const params = template.params as TiltedLeftTemplate["params"]
  const background = template.background as TiltedLeftTemplate["background"]

  return (
    <Card>
      <CardHeader>
        <CardTitle>Tilted Left Properties</CardTitle>
        <CardDescription>
          Customize your tilted left template properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
